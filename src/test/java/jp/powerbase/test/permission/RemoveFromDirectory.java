...
import jp.powerbase.client.command.RemovePermissionFromDirectory;
import jp.powerbase.xmldb.resource.Path;

public class RemoveFromDirectory
{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			CommandInvoker cmd = new RemovePermissionFromDirectory(connector, new Path("/test"), def);
