package jp.powerbase.test.createdirectory;
...
import jp.powerbase.client.command.CreateDirectory;
...
public class TestDirectory
{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			writer.writeAttribute("description", "テスト");	//description
			...
			CommandInvoker cmd = new CreateDirectory(connector, new Path("/"), def);
