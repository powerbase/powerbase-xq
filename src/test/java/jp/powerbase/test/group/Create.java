package jp.powerbase.test.group;
...
import jp.powerbase.client.command.CreateGroup;
...
public class Create
{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			writer.writeAttribute("id", "infinite");
			...
			CommandInvoker cmd = new CreateGroup(connector, def);
