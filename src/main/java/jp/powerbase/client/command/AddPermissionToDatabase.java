...
public class AddPermissionToDatabase extends Invoker implements CommandInvoker {
	private final Command command = Command.ADD_PERMISSION_TO_DATABASE;

	public AddPermissionToDatabase(Connector connector, Path database, Document xml) throws NoSuchAlgorithmException, IOException {
