...
public class ReplaceNode extends Invoker implements CommandInvoker {
	private final Command command = Command.REPLACE_NODE;

	public ReplaceNode(Connector connector, List<ReplaceNodeExpr> exprs) throws MalformedURLException, NoSuchAlgorithmException, UnsupportedEncodingException, XMLStreamException {
	...
	public ReplaceNode(Connector connector, Path resource, String value) throws MalformedURLException, NoSuchAlgorithmException, UnsupportedEncodingException {
		RequestElement rt = new RequestElement(command);
