...
public class CreateDatabase extends Invoker implements CommandInvoker {
	private final Command command = Command.CREATE_DATABASE;

	public CreateDatabase(Connector connector, Path database, Document xml) throws NoSuchAlgorithmException, IOException {
