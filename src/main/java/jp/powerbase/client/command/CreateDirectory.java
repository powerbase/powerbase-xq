...
public class CreateDirectory extends Invoker implements CommandInvoker {
	private final Command command = Command.CREATE_DIRECTORY;

	public CreateDirectory(Connector connector, Path database, Document xml) throws NoSuchAlgorithmException, IOException {
