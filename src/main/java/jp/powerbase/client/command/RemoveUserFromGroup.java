...
public class RemoveUserFromGroup extends Invoker implements CommandInvoker {
	private final Command command = Command.REMOVE_USER_FROM_GROUP;

	public RemoveUserFromGroup(Connector connector, Document xml) throws NoSuchAlgorithmException, IOException {
		client = new Client(connector.getUser(), Method.PUT, connector.getServer().getUrl());
