...
public class AddUserToGroup extends Invoker implements CommandInvoker {
	private final Command command = Command.ADD_USER_TO_GROUP;

	public AddUserToGroup(Connector connector, Document xml) throws NoSuchAlgorithmException, IOException {
