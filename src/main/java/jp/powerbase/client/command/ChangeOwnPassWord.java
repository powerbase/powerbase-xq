...
public class ChangeOwnPassWord extends Invoker implements CommandInvoker {
	private final Command command = Command.CHANGE_OWN_PASSWORD;

	public ChangeOwnPassWord(Connector connector, Document xml) throws NoSuchAlgorithmException, IOException {
