...
public class AddPermissionToDirectory extends Invoker implements CommandInvoker {
	private final Command command = Command.ADD_PERMISSION_TO_DIRECTORY;

	public AddPermissionToDirectory(Connector connector, Path directory, Document xml) throws NoSuchAlgorithmException, IOException {
