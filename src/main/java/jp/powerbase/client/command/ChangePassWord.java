...
public class ChangePassWord extends Invoker implements CommandInvoker {
	private final Command command = Command.CHANGE_PASSWORD;

	public ChangePassWord(Connector connector, Document xml) throws NoSuchAlgorithmException, IOException {
