...
public class CreateUser extends Invoker implements CommandInvoker {
	private final Command command = Command.CREATE_USER;

	public CreateUser(Connector connector, Document xml) throws NoSuchAlgorithmException, IOException {
