/*
 * @(#)$Id: QueryIndexRangeBasedOnSEQ.java 1178 2011-07-22 10:16:56Z hirai $
 *
...
public class QueryIndexRangeBasedOnSEQ extends QueryIndex {
	public QueryIndexRangeBasedOnSEQ(RequestContext ctx) {
		super(ctx);
	}
