/*
 * @(#)$Id: TupleIndexBasedOnSEQ.java 1178 2011-07-22 10:16:56Z hirai $
 *
...
public class TupleIndexBasedOnSEQ extends TupleIndexRangeBasedOnSEQ {
	public TupleIndexBasedOnSEQ(RequestContext ctx) {
		super(ctx);
	}
