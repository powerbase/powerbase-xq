/*
 * @(#)$Id: QueryRangeBasedOnSEQ.java 1178 2011-07-22 10:16:56Z hirai $
 *
...
public class QueryRangeBasedOnSEQ extends Query {
	public QueryRangeBasedOnSEQ(RequestContext ctx) {
		super(ctx);
	}
