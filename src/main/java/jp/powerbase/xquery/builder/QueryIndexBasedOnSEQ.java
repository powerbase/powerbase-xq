/*
 * @(#)$Id: QueryIndexBasedOnSEQ.java 1178 2011-07-22 10:16:56Z hirai $
 *
...
public class QueryIndexBasedOnSEQ extends QueryIndex {
	public QueryIndexBasedOnSEQ(RequestContext ctx) {
		super(ctx);
	}
