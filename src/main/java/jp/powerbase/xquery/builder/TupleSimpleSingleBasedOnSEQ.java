/*
 * @(#)$Id: TupleSimpleSingleBasedOnSEQ.java 1178 2011-07-22 10:16:56Z hirai $
 *
...
public class TupleSimpleSingleBasedOnSEQ extends Tuple {
	public TupleSimpleSingleBasedOnSEQ(RequestContext ctx) {
		super(ctx);
	}
