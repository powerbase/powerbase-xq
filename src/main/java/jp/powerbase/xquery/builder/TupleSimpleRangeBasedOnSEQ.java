/*
 * @(#)$Id: TupleSimpleRangeBasedOnSEQ.java 1178 2011-07-22 10:16:56Z hirai $
 *
...
public class TupleSimpleRangeBasedOnSEQ extends TupleSimpleSingleBasedOnSEQ {
	public TupleSimpleRangeBasedOnSEQ(RequestContext ctx) {
		super(ctx);
	}
	...
	public void buildFor() throws PowerBaseException {
		...
		_for = f.toString() + "[position() = (" + ctx.getRangeMin() + " to " + ctx.getRangeMax() + ")]";
