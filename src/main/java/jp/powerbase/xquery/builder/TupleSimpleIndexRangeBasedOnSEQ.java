/*
 * @(#)$Id: TupleSimpleIndexRangeBasedOnSEQ.java 1178 2011-07-22 10:16:56Z hirai $
 *
...
public class TupleSimpleIndexRangeBasedOnSEQ extends TupleIndex {
	public TupleSimpleIndexRangeBasedOnSEQ(RequestContext ctx) {
		super(ctx);
	}
