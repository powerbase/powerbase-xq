/*
 * @(#)$Id: DocumentDatabase.java 1178 2011-07-22 10:16:56Z hirai $
 *
...
public class DocumentDatabase extends DefaultDatabase {

	DocumentDatabase(Client client, int id, Path path, Type type) throws PowerBaseException {
